...
import { ChevronLeft, Scale, Tag, Link as LinkIcon } from 'lucide-react';
      ...
      <div className="max-w-[1200px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-2">
          ...
          <div className="lg:col-span-8 max-w-[800px] w-full mx-auto space-y-6">
            ...
            {/* Reusable Blog Cover Header */}
            <BlogCover post={post} tools={tools} calculatedReadTime={calculatedReadTime} />

            {/* Share Buttons Bar */}
            <div className="flex items-center justify-end gap-2.5 py-2 border-b border-white/5 text-xs text-slate-400">
              <span className="font-semibold text-slate-500 mr-1">Share this article:</span>
              <button
